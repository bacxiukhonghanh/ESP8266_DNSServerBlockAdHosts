// Original file: https://github.com/esp8266/Arduino/blob/master/libraries/DNSServer/src/DNSServer.h

#ifndef MyDNSServer_h
#define MyDNSServer_h
#include <WiFiUdp.h>
...
class MyDNSServer
{
  ...
  private:
    WiFiUDP _udp;
    uint16_t _port;
    unsigned char _IPForDetectedHosts[4];
    uint32_t _ttl;
